...
const ServiceCard = ({ service }) => {
  const { serviceName, price, rating, img, description } = service;
  return (
    <div>
      <div className="card card-compact rounded-xl w-96 bg-base-100 border shadow-xl">
        <figure>
        ...
        <div className="card-body">
          ...
          <div className="">
            <button className="btn bg-red-500 hover:bg-red-700 border-none my-3">Check Details</button>
          </div>
        </div>
      </div>
    </div>
